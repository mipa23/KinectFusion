...
public:
    ...
    bool estimatePose(CameraParametersPyramid cameraParams, int i, std::shared_ptr<SurfaceMeasurement> prev_frame, std::shared_ptr<SurfaceMeasurement> current_frame, size_t m_nIterations, Eigen::Matrix4d& estimated_pose, int numLevels);
...
private:
    ...
    void findCorrespondence(CameraParametersPyramid cameraParams, std::shared_ptr<SurfaceMeasurement> prev_frame, std::shared_ptr<SurfaceMeasurement> curr_frame, std::vector<std::pair<size_t, size_t>>& corresponding_points, Eigen::Matrix4d& estimated_pose, int numLevels);
